...
<head>
    ...
    <title>Bagou450 - {{$BlogTitle}} </title>
                                ...
                                <tr>
                                    <td align="center" valign="middle" style="padding-top:40px;padding-bottom:40px"
                                        ...
                                        <a href="https://bagou450.com" target="_blank" style="text-decoration:none;">
                                            <img src="https://cdn.bagou450.com/assets/img/logo_full_colored.png" alt=""
                                                 width="150" border="0"
                                ...
                                <tr>
                                    <td align="center" valign="top" style="padding-bottom:40px" class="imgHero">
                                        ...
                                        <a href="#" target="_blank" style="text-decoration:none;">
                                            <img src="https://cdn.bagou450.com/assets/img/mail/hearth.png" width="600"
                                                 alt="" border="0"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tr>
                                                <td align="center" valign="top" style="padding-bottom:20px;"
                                                    ...
                                                    <!-- Description Text// -->
                                                    <p class="text"
                                                       style="padding-bottom:20px; color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; margin:0">
                                                        We are thrilled to announce the release of our newest blog post!
                                                        Our team has been working diligently to bring you this latest
                                                        piece, filled with insightful information and engaging content.
                                                    </p>
                                                    <p class="text"
                                                       style="padding-bottom:20px; color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; margin:0">
                                                        This article is a culmination of our efforts to provide you with
                                                        the most relevant and thought-provoking topics. We believe it
                                                        will offer you fresh perspectives, valuable knowledge, and
                                                        perhaps even spark some new ideas.
                                                    </p>
                                                    <p class="text"
                                                       style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
                                                        ...
                                                        Don't miss out on this exciting read. Check it out now and join
                                                        the conversation!
                                                    </p>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center" class="ctaButton"
                                                                ...
                                                                <!-- Button Link // -->
                                                                <a class="text"
                                                                   href="https://bagou450.com/blog/{{$blogSlug}}"
                                                                   target="_blank"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="footer">
                                    ...
                                    <td align="center" valign="top"
                                        ...
                                        <p class="text"
                                           style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                            &copy;&nbsp;Bagou450 SARL | 2 rue des orchidées | 35450 Dourdain, France.
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" valign="top"
                                        ...
                                        <p class="text"
                                           style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                            <a href="https://bagou450.com/pp"
                                               style="color:#777777;text-decoration:underline;" target="_blank"> Privacy
                                                Policy </a>
                                        </p>
                                    </td>
                                </tr>
                                        ...
                                        <p class="text"
                                           style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                            If you have any quetions please contact us <a
                                                    ...
                                                    style="color:#777777;text-decoration:underline;" target="_blank">mail@bagou450.com</a>.<br>

                                        </p>
                                        <p class="text"
                                           style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
                                            Prefer not to receive our emails? You can <a href="https://bagou450.com/account"
                                                                                         style="color:#777777;text-decoration:underline;" target="_blank">unsubscribe here</a>.<br>
                                        </p>
                                    </td>
                                </tr>
