...
<div class="container">
    ...
    <p>Dear user,</p>
    <p>We have received a request to authenticate your account. Please click the button below to proceed:</p>
    <a href="https://privatewebsite.bagou450.com/login/token/{{$loginlink}}" class="button">
        Authenticate Your Account
    </a>
    <p>If you are unable to click the button above, please copy and paste the following link into your browser:</p>
    <p>https://privatewebsite.bagou450.com/login/token/{{$loginlink}}</p>
